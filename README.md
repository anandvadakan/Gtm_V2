...
- Twitter/X: 20 tweets max (credit-efficient)
- Google News: market signals
- Median sentiment scoring (not average)
- Competitor gap analysis
- Launch playbook mode with pre-launch, launch day, first week actions
- PDF export
- SynapseX-inspired dark futuristic UI (Space Mono, dot grid, scramble animations)
